...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <div class="top-nav" id="home">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-auto">
                    <p> <i class='bx bxs-envelope'></i> developer@gmail.com</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a target="_blank" class="nav-link" href="user_details/users.php">Staff List</a>
                    </li>
                    <li class="nav-item">
                        <a target="_blank" class="nav-link" href="login.php">Login</a>
                    </li>
                    <li class="nav-item">
                        <a target="_blank" class="nav-link" href="signup.php">Sign Up</a>
                    </li>
                   
                </ul>
                <a href="dashboard.php" class="btn btn-brand ms-lg-3">Dashboard</a>
            </div>
        </div>
    </nav>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 py-5">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="info-box">
                                <img src="front/img/icon6.png" alt="">
                                <div class="ms-4">
                        ...
                        <div class="col-12 mt-4">
                            <div class="info-box">
                                <img src="front/img/icon4.png" alt="">
                                <div class="ms-4">
                        ...
                        <div class="col-12 mt-4">
                            <div class="info-box">
                                <img src="front/img/icon5.png" alt="">
                                <div class="ms-4">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="service">
                        <img src="front/img/icon1.png" alt="">
                        <h5>Digital Marketing</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service">
                        <img src="front/img/icon2.png" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service">
                        <img src="front/img/icon3.png" alt="">
    ...
    <section class="bg-light" id="portfolio">
        ...
        <div id="projects-slider" class="owl-theme owl-carousel">
            <div class="project">
                ...
                <img src="front/img/project1.jpg" alt="">
                <div class="content">
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="front/img/project2.jpg" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="front/img/project3.jpg" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="front/img/project4.jpg" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="front/img/project5.jpg" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="front/img/team_1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="front/img/team_2.jpg" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="front/img/team_3.jpg" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
    ...
    <footer>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        ...
                        <p>We Make all Dynamic and Professional website in Low Cost</p>
                        <div class="col-auto social-icons">
                            <a href="#"><i class='bx bxl-facebook'></i></a>
                            <a href="#"><i class='bx bxl-twitter'></i></a>
                            <a href="#"><i class='bx bxl-instagram'></i></a>
        ...
        <div class="footer-bottom text-center">
            <p class="mb-0">&copy; Copyright Prixima 2022. All rights Reserved</p> Desigend By <a hrefs="#">Shadhiul Islam Khan</a>
        </div>
    </footer>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div class="container-fluid">
                        <div class="row gy-4">
                            <div class="col-lg-4 col-sm-12 bg-cover" style="background-image: url(front/img/c2.jpg); min-height:300px;">
                                <div>
